...
Dit document is onderdeel van _NLgov REST API Design Rules_.
...
Het **Beheermodel** voor deze standaard is gepubliceerd op: <https://gitdocumentatie.logius.nl/publicatie/api/beheermodel/>
