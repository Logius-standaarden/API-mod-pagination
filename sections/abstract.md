...
| Normative        | [API Design Rules (ADR v2)](https://gitdocumentatie.logius.nl/publicatie/api/adr/2/) |
...
| Normative module | [GEO module v1.0](https://gitdocumentatie.logius.nl/publicatie/api/mod-geo/1.0/) |
